...
public:
	...
	TSubclassOf<class USoundModulationParameter>  ParamClassFilter;                                  // 0x0020(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
