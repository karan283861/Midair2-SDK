...
#include "BP_OOBGrid_classes.hpp"
#include "BP_OOBGrid_parameters.hpp"
...
void ABP_OOBGrid_C::ExecuteUbergraph_BP_OOBGrid(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_OOBGrid_C", "ExecuteUbergraph_BP_OOBGrid");

	Params::BP_OOBGrid_C_ExecuteUbergraph_BP_OOBGrid Parms{};
...
void ABP_OOBGrid_C::BP_PlayOOBEffects(class AActor* ActorExiting, const struct FVector& Location, const struct FVector& WallNormal)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_OOBGrid_C", "BP_PlayOOBEffects");

	Params::BP_OOBGrid_C_BP_PlayOOBEffects Parms{};
...
void ABP_OOBGrid_C::UserConstructionScript()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_OOBGrid_C", "UserConstructionScript");
...
void ABP_OOBGrid_C::ApplyFadeSetting(class UPrimitiveComponent* Component, float FadeDistance, class UMaterialInstanceDynamic** Material)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_OOBGrid_C", "ApplyFadeSetting");

	Params::BP_OOBGrid_C_ApplyFadeSetting Parms{};
