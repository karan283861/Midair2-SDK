...
#include "BP_Blaster_ChargedBolt_classes.hpp"
#include "BP_Blaster_ChargedBolt_parameters.hpp"
...
void ABP_Blaster_ChargedBolt_C::ExecuteUbergraph_BP_Blaster_ChargedBolt(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Blaster_ChargedBolt_C", "ExecuteUbergraph_BP_Blaster_ChargedBolt");

	Params::BP_Blaster_ChargedBolt_C_ExecuteUbergraph_BP_Blaster_ChargedBolt Parms{};
...
void ABP_Blaster_ChargedBolt_C::ReceiveHit(class UPrimitiveComponent* MyComp, class AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, const struct FVector& HitLocation, const struct FVector& HitNormal, const struct FVector& NormalImpulse, const struct FHitResult& Hit)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_Blaster_ChargedBolt_C", "ReceiveHit");

	Params::BP_Blaster_ChargedBolt_C_ReceiveHit Parms{};
...
void ABP_Blaster_ChargedBolt_C::ReceiveBeginPlay()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_Blaster_ChargedBolt_C", "ReceiveBeginPlay");
