...
struct BP_LightCharacter_C_ExecuteUbergraph_BP_LightCharacter final
{
public:
	int32                                         EntryPoint;                                        // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_bFirstPerson;                         // 0x0004(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
DUMPER7_ASSERTS_BP_LightCharacter_C_ExecuteUbergraph_BP_LightCharacter;

// Function BP_LightCharacter.BP_LightCharacter_C.ReceiveTick
// 0x0004 (0x0004 - 0x0000)
struct BP_LightCharacter_C_ReceiveTick final
{
public:
	float                                         DeltaSeconds;                                      // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_LightCharacter_C_ReceiveTick;

// Function BP_LightCharacter.BP_LightCharacter_C.BP_UpdateForClientPerspective
// 0x0001 (0x0001 - 0x0000)
struct BP_LightCharacter_C_BP_UpdateForClientPerspective final
{
public:
	bool                                          bFirstPerson;                                      // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
DUMPER7_ASSERTS_BP_LightCharacter_C_BP_UpdateForClientPerspective;
