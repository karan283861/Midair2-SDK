...
namespace Offsets
{
	constexpr int32 GObjects          = 0x06290360;
	constexpr int32 AppendString      = 0x01ECB530;
	constexpr int32 GNames            = 0x06253D80;
	constexpr int32 GWorld            = 0x063D5FB0;
	constexpr int32 ProcessEvent      = 0x020DD000;
