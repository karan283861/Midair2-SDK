...
public:
	...
	class UObject*                                WorldContextObject;                                // 0x0070(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)

public:
	static class UDestroySessionCallbackProxy* DestroySession(class UObject* WorldContextObject_0, class APlayerController* PlayerController);
...
public:
	...
	static int32 GetCurrentNumberOfBots(const struct FBlueprintSessionResult& Result);
	static int32 GetCurrentNumberOfBotsAndPlayers(const struct FBlueprintSessionResult& Result);
	static int32 GetCurrentPlayers(const struct FBlueprintSessionResult& Result);
	static class FString GetCustomServerName(const struct FBlueprintSessionResult& Result);
	...
	static class FString GetMessageOfTheDay(const struct FBlueprintSessionResult& Result);
	static bool GetOfficialServer(const struct FBlueprintSessionResult& Result);
	static int32 GetPingInMs(const struct FBlueprintSessionResult& Result);
	static class FString GetServerAddress(const struct FBlueprintSessionResult& Result);
	static class FString GetServerName(const struct FBlueprintSessionResult& Result);
	static class FString GetServerVersion(const struct FBlueprintSessionResult& Result);
	static bool IsPasswordProtected(const struct FBlueprintSessionResult& Result);
	static bool IsServerAdvertised(const struct FBlueprintSessionResult& Result);
	static bool IsTournamentModeEnabled(const struct FBlueprintSessionResult& Result);
