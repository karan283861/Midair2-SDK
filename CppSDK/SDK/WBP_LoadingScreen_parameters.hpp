...
public:
	...
	class FText                                   CallFunc_GetObjectives_ReturnValue;                // 0x0008(0x0018)()
	bool                                          CallFunc_TextIsEmpty_ReturnValue;                  // 0x0020(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_GetTip_ReturnValue;                       // 0x0028(0x0018)()
	...
	class UTexture2D*                             CallFunc_GetBackground_ReturnValue;                // 0x0090(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FString                                 CallFunc_GetMapName_ReturnValue;                   // 0x0128(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	class FText                                   CallFunc_GetMapLore_ReturnValue;                   // 0x0158(0x0018)()
	bool                                          CallFunc_TextIsEmpty_ReturnValue_1;                // 0x0170(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_171[0x7];                                      // 0x0171(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_GetAuthors_ReturnValue;                   // 0x0178(0x0018)()
