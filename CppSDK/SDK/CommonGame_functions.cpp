...
// class UAsyncAction_CreateWidgetAsync*   ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// bool                                    bSuspendInputUntilComplete                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UAsyncAction_PushContentToLayerForPlayer*ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// class UCommonGameDialogDescriptor*      Descriptor_0                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UAsyncAction_ShowConfirmation*    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// Function CommonGame.AsyncAction_ShowConfirmation.ShowConfirmationOk
// (Final, BlueprintCosmetic, Native, Static, Public, BlueprintCallable)
// Parameters:
// class UObject*                          InWorldContextObject                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UAsyncAction_ShowConfirmation* UAsyncAction_ShowConfirmation::ShowConfirmationOk(class UObject* InWorldContextObject, const class FText& Title, const class FText& Message)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AsyncAction_ShowConfirmation", "ShowConfirmationOk");

	Params::AsyncAction_ShowConfirmation_ShowConfirmationOk Parms{};
...
// Parameters:
// const class UUserWidget*                WidgetContextObject                                    (ConstParm, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// const struct FGameplayTag&              LayerName                                              (Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TSubclassOf<class UCommonActivatableWidget>WidgetClass                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// Function CommonGame.PrimaryGameLayout.GetPrimaryGameLayout
// (Final, Native, Static, Public, BlueprintCallable)
// Parameters:
// class APlayerController*                PlayerController                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UPrimaryGameLayout*               ReturnValue                                            (ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class UPrimaryGameLayout* UPrimaryGameLayout::GetPrimaryGameLayout(class APlayerController* PlayerController)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("PrimaryGameLayout", "GetPrimaryGameLayout");

	Params::PrimaryGameLayout_GetPrimaryGameLayout Parms{};
...
// Function CommonGame.PrimaryGameLayout.GoToMainMenu
// (Final, Native, Public, BlueprintCallable)

void UPrimaryGameLayout::GoToMainMenu()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PrimaryGameLayout", "GoToMainMenu");
...
// Function CommonGame.PrimaryGameLayout.GoToPressStartScreen
// (Final, Native, Public, BlueprintCallable)

void UPrimaryGameLayout::GoToPressStartScreen()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PrimaryGameLayout", "GoToPressStartScreen");
...
// class UCommonActivatableWidgetContainerBase*LayerWidget                                            (Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
