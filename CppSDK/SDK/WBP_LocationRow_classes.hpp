...
// WidgetBlueprintGeneratedClass WBP_LocationRow.WBP_LocationRow_C
// 0x0090 (0x02F0 - 0x0260)
class UWBP_LocationRow_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_WBP_LocationRow(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("WBP_LocationRow_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"WBP_LocationRow_C")
	}
	static class UWBP_LocationRow_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWBP_LocationRow_C>();
	}
};
DUMPER7_ASSERTS_UWBP_LocationRow_C;
