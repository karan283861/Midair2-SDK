...
// BlueprintGeneratedClass BP_Catch_Ring.BP_Catch_Ring_C
// 0x0048 (0x0270 - 0x0228)
class ABP_Catch_Ring_C final : public AActor
{
public:
...
public:
	void ExecuteUbergraph_BP_Catch_Ring(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_Catch_Ring_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_Catch_Ring_C")
	}
	static class ABP_Catch_Ring_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_Catch_Ring_C>();
	}
};
DUMPER7_ASSERTS_ABP_Catch_Ring_C;
