...
class ABP_PlasmaGun_Explosion_C final : public AMAImpactEffect
{
public:
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_PlasmaGun_Explosion_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_PlasmaGun_Explosion_C")
	}
	static class ABP_PlasmaGun_Explosion_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_PlasmaGun_Explosion_C>();
	}
};
DUMPER7_ASSERTS_ABP_PlasmaGun_Explosion_C;
