...
struct BP_ChaingunAttachment_C_ExecuteUbergraph_BP_ChaingunAttachment final
{
public:
...
DUMPER7_ASSERTS_BP_ChaingunAttachment_C_ExecuteUbergraph_BP_ChaingunAttachment;

// Function BP_ChaingunAttachment.BP_ChaingunAttachment_C.ReceiveTick
// 0x0004 (0x0004 - 0x0000)
struct BP_ChaingunAttachment_C_ReceiveTick final
{
public:
	float                                         DeltaSeconds;                                      // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_ChaingunAttachment_C_ReceiveTick;
