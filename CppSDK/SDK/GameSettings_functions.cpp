...
// class UGameResponsivePanelSlot*         ReturnValue                                            (ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UGameSettingListEntrySetting_Dropdown::HandleSelectionChanged(const class FString& SelectedItem, ESelectInfo SelectionType)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GameSettingListEntrySetting_Dropdown", "HandleSelectionChanged");

	Params::GameSettingListEntrySetting_Dropdown_HandleSelectionChanged Parms{};
...
void UGameSettingListEntrySetting_SpinBox::HandleValueCommited(float InValue, ETextCommit CommitMethod)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GameSettingListEntrySetting_SpinBox", "HandleValueCommited");

	Params::GameSettingListEntrySetting_SpinBox_HandleValueCommited Parms{};
...
void UGameSettingListEntrySetting_SpinBox::OnValueChanged(float DefaultValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GameSettingListEntrySetting_SpinBox", "OnValueChanged");

	Params::GameSettingListEntrySetting_SpinBox_OnValueChanged Parms{};
...
// class UGameSettingCollection*           ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FLinearColor UGameSettingValueDiscreteDynamic_Color::GetValue() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GameSettingValueDiscreteDynamic_Color", "GetValue");

	Params::GameSettingValueDiscreteDynamic_Color_GetValue Parms{};
